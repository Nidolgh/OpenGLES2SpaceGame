...
IMGUI_API ImVec2 ImBezierClosestPointCasteljau(const ImVec2& p1, const ImVec2& p2, const ImVec2& p3, const ImVec2& p4,
...
enum ImGuiSelectableFlagsPrivate_
{
	...
	// FIXME: We may be able to remove this (added in 6251d379 for menus)
